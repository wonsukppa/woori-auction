...
export default function AnalysisPanel({ 
  ...
  const [repairCost, setRepairCost] = useState(15000000);
  const [evictionCost, setEvictionCost] = useState(5000000);
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20, paddingBottom: isMobile ? 100 : 0 }}>
            ...
            <div style={{ background: '#f0f7ff', borderRadius: 20, padding: '28px 24px', border: '1px solid #bfdbfe', position: 'relative', boxShadow: 'inset 0 2px 4px rgba(18, 104, 251, 0.05)' }}>
              ...
              <div style={{ background: 'white', padding: '16px 20px', borderRadius: 14, marginBottom: 28, border: '1px dashed #93c5fd', display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                ...
                <div style={{ fontSize: 13, color: '#475569', lineHeight: 1.6, fontWeight: 600 }}>
                  최근 3년간 해당 지역 유사 물건 낙찰 데이터를 기반으로 분석한 결과, <span style={{ color: '#1268FB', fontWeight: 800 }}>시세의 82% ({formatPrice(activeProperty.marketPrice * 0.82)})</span>에서 입찰할 경우 낙찰 확률 85% 이상 및 10%대 안전 마진을 기대할 수 있습니다.
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <div style={{ textAlign: 'center', marginTop: 24, marginBottom: 8 }}>
                  <div style={{ fontSize: 42, fontWeight: 950, color: '#1268FB', letterSpacing: -1.5 }}>
            ...
            {(() => {
              ...
              const formatPrecise = (val: number) => {
                ...
                return (val / 10000).toLocaleString('ko-KR', { minimumFractionDigits: 0, maximumFractionDigits: 2 }) + '만';
              };

              return (
                <div style={{ background: 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)', borderRadius: 24, padding: 28, color: 'white', boxShadow: '0 12px 40px rgba(0,0,0,0.2)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 28 }}>
                    ...
                    <span style={{ fontSize: 17, fontWeight: 900, color: '#f8fafc' }}>AI 종합 투자 수익률(ROI) 예측</span>
                  </div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    ...
                    <div style={{ marginTop: 32, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 10 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div style={{ padding: '8px 16px', background: roe > 0 ? '#064e3b' : '#450a0a', color: roe > 0 ? '#34d399' : '#f87171', borderRadius: 10, fontSize: 14, fontWeight: 900, border: `1px solid ${roe > 0 ? '#065f46' : '#7f1d1d'}`, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
                    ...
                    <div style={{ marginTop: 28, background: 'rgba(0,0,0,0.25)', borderRadius: 20, padding: 24, border: '1px solid rgba(255,255,255,0.05)' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
                        ...
                        <span style={{ fontSize: 13, fontWeight: 800, color: '#94a3b8' }}>AI 딥러닝 기간별 수익 예측 (과거 5년치 실거래가 학습)</span>
                      </div>
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
                        <div style={{ textAlign: 'center' }}>
                          <div style={{ fontSize: 12, color: '#64748b', fontWeight: 700, marginBottom: 8 }}>1년 후</div>
                          <div style={{ fontSize: 16, fontWeight: 900, color: '#34d399' }}>+{formatPrecise(profit1Y)}</div>
                        </div>
                        <div style={{ textAlign: 'center', borderLeft: '1px solid rgba(255,255,255,0.1)', borderRight: '1px solid rgba(255,255,255,0.1)' }}>
                          <div style={{ fontSize: 12, color: '#64748b', fontWeight: 700, marginBottom: 8 }}>3년 후</div>
                          <div style={{ fontSize: 16, fontWeight: 900, color: '#34d399' }}>+{formatPrecise(profit3Y)}</div>
                        </div>
                        <div style={{ textAlign: 'center' }}>
                          <div style={{ fontSize: 12, color: '#64748b', fontWeight: 700, marginBottom: 8 }}>5년 후</div>
                          <div style={{ fontSize: 16, fontWeight: 900, color: '#34d399' }}>+{formatPrecise(profit5Y)}</div>
                        </div>
                      </div>
                    </div>
                  </div>
